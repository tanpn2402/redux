...
class StockInfoDetail extends React.Component {
    ...
    render() {
        ...
        let config = {
            ...
            inCharts: [] /*[["InChartVol"],["InChartSMA",[60]],["InChartBB"]]*/,
            subCharts: [["Vol", [], 125]] /*[["Volume", [], 125], ["RSI", [11], 100], ["MACD", [13,5,3], 125]]*/,
        ...
        return (
            <div className="stockinfo-detail">
                ...
                <div className="stockinfo-chart" style={{marginTop: "10px"}} >
                    <Chart height={150} maxHeight={310} rawData={test} config={config} />
                </div>
