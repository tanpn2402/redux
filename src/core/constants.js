export const ActionTypes = {
    ...
    RESETENQUIRYORDERDATA: "RESETENQUIRYORDERDATA",
    //
    ...
    ADDINSTRUMENTTOWATCH: 'ADDINSTRUMENTTOWATCH',
    REMOVEINSTRUMENTFROMWATCH: 'REMOVEINSTRUMENTFROMWATCH',
    ...
    GETLISTSTOCKINWATCHLIST: 'GETLISTSTOCKINWATCHLIST',
  
    GETDERIVATIVELIST: "GETDERIVATIVELIST",
    UPDATEDERIVATIVEDATA: "UPDATEDERIVATIVEDATA",
  
    // TRADE LOG
    UPDATETRADELOG: 'UPDATETRADELOG',
    GETTRADELOGDATA: 'GETTRADELOGDATA',
    GETTRADELOGDATAFOREACH: 'GETTRADELOGDATAFOREACH',
    ...
    // PHAI SINH : FUTURE SECURITY
    GETFSSERIES: "GETFSSERIES",
    GETFSSUBACCOUNT: "GETFSSUBACCOUNT",
    ORDERENQUIRYFS: "ORDERENQUIRYFS",
    ORDERHISTORYFS: "ORDERHISTORYFS",
    CLIENTPORTFOLIOENQUIRYFS: "CLIENTPORTFOLIOENQUIRYFS",
    CASHBALANCEENQUIRYFS: "CASHBALANCEENQUIRYFS",
    SUBMITCPCASHDWFS: "SUBMITCPCASHDWFS",
    CPCASHDWENQUIRYFS: "CPCASHDWENQUIRYFS",
    CASHTRANSFERENQUIRYFS: "CASHTRANSFERENQUIRYFS",
    DELETECASHDWFS: "DELETECASHDWFS",
    SUBMITCASHDWFS: "SUBMITCASHDWFS",
