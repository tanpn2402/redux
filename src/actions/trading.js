...
export function updateWatchlistData(listStock) {
    ...
    let stockCode = config.cache.listInstrumentToWatch[marIndex]
        ...
        let data = {
            ...
            mvBidVol1: utils.randomInt(1000000),
            mvBidVol2: utils.randomInt(1000000),
            mvBidVol3: utils.randomInt(1000000),

            mvMatchPrice: utils.round(80+ parseFloat(Math.random().toFixed(2)), 1),
            mvMatchVol: utils.randomInt(1000000),
            mvMatchUpDown: utils.round(1 + parseFloat(Math.random().toFixed(2)), 1),
            mvMatchVolTotal: utils.randomInt(1000000),
            ...
            mvOfferVol1: utils.randomInt(1000000),
            mvOfferVol2: utils.randomInt(1000000),
            mvOfferVol3: utils.randomInt(1000000),
