...
export const ENQUIRYHISTORYORDER = 'enquiryhistotyorder.action';// get order history
...
export const ENQUIRYODDLOT = 'enquiryOddLot';	// enquiry odd lot portfolio
...
export const CHECKADVANCEPAYMENTTIME = 'upcomingdebt.action';	// check time for advance request
